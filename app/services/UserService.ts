...
export default class UserService {
    ...
    constructor() {
        this.dummyData = [
            ...
            new User(3, "Luka", "Lukić", "http://www.ccusersforum.org/images/user.png"),
            new User(4, "Toni", "Martić", "http://icons.iconarchive.com/icons/hopstarter/scrap/256/User-icon.png"),
            new User(5, "Ivan", "Ivić", "http://icons.iconarchive.com/icons/double-j-design/origami-colored-pencil/256/blue-user-icon.png"),
            new User(6, "Jure", "Jurić", "https://image.freepik.com/free-icon/user-male-shape-in-a-circle-ios-7-interface-symbol_318-39025.jpg"),
            new User(7, "Dino", "Dinosaurić", "http://downloadicons.net/sites/default/files/user-icon-45917.png"),
            new User(8, "Ivana", "Ivanković", "https://upload.wikimedia.org/wikipedia/en/thumb/c/ce/User-info.svg/1024px-User-info.svg.png"),
